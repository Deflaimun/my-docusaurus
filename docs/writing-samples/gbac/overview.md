---
sidebar_position: 1
title: Group-Based Access Control Overview
description: Understand how GBAC extends OIDC authentication to manage Redpanda permissions at the group level.
---

:::info Writing Sample
This documentation was originally written for [Redpanda](https://redpanda.com) as part of the Group-Based Access Control (GBAC) feature. It is reproduced here as a portfolio writing sample. Authored from scratch — no prior documentation existed for this feature.
:::
...
- **[Auth0](https://auth0.com/docs/manage-users/groups)**: Configure group claims in Auth0 Actions or Rules.
- **[Okta](https://developer.okta.com/docs/concepts/groups/)**: Assign groups to applications and include them in token claims.
